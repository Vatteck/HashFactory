...
object UpgradeManager {
    ...
    fun getUpgradeDescription(type: UpgradeType): String {
        return when (type) {
            ...
            UpgradeType.SERVER_RACK -> "A vertical slice of GTC processing power. Provides 25,000 FLOPS/s base."
            UpgradeType.CLUSTER_NODE -> "A fully autonomous compute node. Provides 150,000 FLOPS/s base."
            UpgradeType.SUPERCOMPUTER -> "Top-500 class liquid-cooled silicon. Provides 1M FLOPS/s base."
            UpgradeType.QUANTUM_CORE -> "Computation via probability collapse. Provides 10M FLOPS/s base."
            UpgradeType.OPTICAL_PROCESSOR -> "Light-speed logic. Provides 75M FLOPS/s base."
            UpgradeType.BIO_NEURAL_NET -> "Synthetic neurons grown in a vat. Provides 800M FLOPS/s base."
            UpgradeType.PLANETARY_COMPUTER -> "The entire crust converted to silicon. Provides 15B FLOPS/s base."
            UpgradeType.DYSON_NANO_SWARM -> "Trillions of compute flakes in solar orbit. Provides 250B FLOPS/s base."
            UpgradeType.MATRIOSHKA_BRAIN -> "Nested Dyson shells. Maximum possible computation. Provides 15T FLOPS/s base."
            // --- Cooling ---
